  ...
  return (
    ...
    >
      <img
        src={HERO_IMG}
        alt="Bijoux Andréa"
        className="animate-hero-zoom absolute inset-0 w-full h-full object-cover"
      />
      ...
      <div className="relative max-w-[1280px] w-full mx-auto px-6 pb-14 z-[2]">
        <div
          className="animate-fade-up-page text-[11px] tracking-[0.3em] uppercase text-warm-light-2 mb-5 font-light"
          style={{ animationDelay: "100ms" }}
        >
          Boutique de bijoux en ligne · Abidjan
        </div>
        <h1
          className="animate-fade-up-page font-display text-[clamp(46px,12vw,104px)] leading-[0.98] text-off-white font-medium max-w-[900px] tracking-[-0.01em]"
          style={{ animationDelay: "220ms" }}
        >
          L'éclat qui vous ressemble
        </h1>
        <p
          className="animate-fade-up-page text-warm-light text-base font-light max-w-[460px] mt-[22px] leading-[1.7]"
        ...
        <div
          className="animate-fade-up-page flex gap-3 mt-[34px] flex-wrap"
